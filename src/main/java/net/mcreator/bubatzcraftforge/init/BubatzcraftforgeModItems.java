...
import net.mcreator.bubatzcraftforge.item.SnusItem;
...
public class BubatzcraftforgeModItems {
	...
	public static final RegistryObject<Item> SNUS_HELMET = REGISTRY.register("snus_helmet", () -> new SnusItem.Helmet());
