...
public class DrugStoreFeature extends Feature<NoneFeatureConfiguration> {
	public static DrugStoreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new DrugStoreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("bubatzcraftforge:drug_store", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("bubatzcraftforge:drug_store", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
