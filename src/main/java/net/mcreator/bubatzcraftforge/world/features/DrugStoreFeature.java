...
public class DrugStoreFeature extends Feature<NoneFeatureConfiguration> {
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("savanna_plateau"), new ResourceLocation("forest"),
			new ResourceLocation("sunflower_plains"), new ResourceLocation("giant_tree_taiga"), new ResourceLocation("giant_spruce_taiga"),
			new ResourceLocation("dark_forest"), new ResourceLocation("taiga"), new ResourceLocation("savanna"), new ResourceLocation("plains"),
			new ResourceLocation("flower_forest"), new ResourceLocation("swamp"), new ResourceLocation("tall_birch_forest"));
